  ...
  <div class="edit-ds-page">
    ...
    <template v-if="currentDataset">
      ...
      <div class="list-fullscreen-wrap" :class="{ 'fullscreen-active': listFullscreen }">
        ...
        <div v-else-if="viewMode === 'grid'" class="image-grid" :key="'grid-' + viewMode">
          <div v-for="img in images" :key="img.id" class="image-card" :class="{ selected: selectedIds.has(img.id) }">
            ...
            <div class="image-thumb" @click="openDetail(img)">
              <img :src="datasetImageUrl(currentDataset.id, img.relative_path, true)" :alt="img.filename" loading="lazy" @error="onImgError($event)" />
        ...
        <div v-else class="image-list-wrap" :key="'list-' + viewMode">
          <div class="image-list">
            ...
            <div v-for="img in filteredImages" :key="img.id" class="list-row" :class="{ selected: selectedIds.has(img.id), saving: savingIds.has(img.id) }" :style="gridStyle">
              ...
              <div class="col col-thumb">
                <img :src="datasetImageUrl(currentDataset.id, img.relative_path, true)" :alt="img.filename" loading="lazy" @error="onImgError($event)" @click="openDetail(img)" />
              </div>
    ...
    >
      <div v-if="detailImage" class="detail-content">
        <div class="detail-preview">
          ...
          <img
            :src="datasetImageUrl(currentDataset.id, detailImage.relative_path, true)"
          ...
          >
            <img
              ...
              :src="datasetImageUrl(currentDataset.id, detailImage.mask_relative_path, true)"
